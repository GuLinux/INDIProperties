...
Number::single_property Number::new_property(const string& name, const string& label, double min, double max, double step, double val, const string format)
{
  single_property s;
...
bool Number::update(double* values, char* names[], int n)
{
